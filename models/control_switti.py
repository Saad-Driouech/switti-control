...
class SpatialEncoder(nn.Module):
    ...
    def __init__(self, num_modalities: int = 7, out_dim: int = 1024):
        super().__init__()
...
class SwittiControlNet(nn.Module):
    ...
    def __init__(self, frozen_switti: Switti, num_modalities: int = 7, use_gradient_checkpointing: bool = False):
        super().__init__()
